    ...
    <footer className="bg-[#1a1a1a] pt-14 pb-8 px-5 md:px-10">
      <div className="max-w-[940px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-white/10">
        ...
        <div>
          ...
          <p className="text-[12.5px] leading-relaxed text-white/55 font-dm-sans">
            <a href="mailto:contato@cannoli.food" className="text-orange no-underline">📧 contato@cannoli.food</a><br /><br />
            📞 (11) 91680-4011<br /><br />
            Av. Ibirapuera, 787 · Avenida Ibirapuera<br />
            São Paulo · SP · 04029-000<br /><br />
            <strong className="text-white/70">Redes Sociais</strong>
          </p>
          
          <div className="flex gap-2.5 mt-3.5">
            <a href="#" className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center hover:bg-orange transition">
              <svg viewBox="0 0 24 24" className="w-[15px] h-[15px] fill-white/70">
